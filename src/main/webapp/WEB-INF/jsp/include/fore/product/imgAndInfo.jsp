            ...
            $.get(
                ...
                function(result){
                    if("success"==result){
                        ...
                        $("span.errorMessage").html("用户不存在或密码错误");
                        $("div.loginErrorMessageDiv").show();
                    }
                }
            );
...
<div class="imgAndInfo">
    ...
    <div class="imgInimgAndInfo">
        <img src="img/productSingle/${p.defaultProductImage.id}.jpg" class="bigImg">
        <div class="smallImageDiv">
            <c:forEach items="${p.productImages}" var="pi">
